...
for line1 in wire1:
    for line2 in wire2:
        ...
        if intersection != None and intersection != (0, 0) and is_point_on_line(intersection, line1) and is_point_on_line(intersection, line2):
            intersections.append(intersection)

distance = 99999999999999999
for point in intersections:
    distance = min(distance, manhattan_distance(point, (0, 0)))
